...
int main()
{
    ...
    std::cout << "If the risk-free rate is zero." <<std::endl;
    std::cout << "===================== " <<std::endl;
    ...
    std::cout << "C(0) = "<<  delta << " * " << S_0  <<  " + " << y << " * "<< A_0 << " = "<< delta * S_0 + y * A_0 <<std::endl;
    std::cout << "===================== " <<std::endl;
    ...
    std::cout << "The value of the call initally C(0)= (p * C_u(T) + (1 - p) * C_d(T))*exp(-(r*T))" <<std::endl;
